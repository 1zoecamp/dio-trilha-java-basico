## Sintaxe - Desafio
obs.: desafio copiado de https://github.com/digitalinnovationone/trilha-java-basico/tree/main/desafios/sintaxe
...
obs.: revise sobre regras de declaração de variáveis
...
obs.: revise sobre terminal, `main args` e a classe Scanner
